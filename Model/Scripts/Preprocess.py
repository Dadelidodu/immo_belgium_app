...
class Preprocessor:
    ...
    def __init__(
        ...
        scored_columns: list = [
            ...
            "Livable Space (m2)",
            "Subtype of Property Score",
            "State of the Building Score",
            "PEB Score",
    ...
    def split_sets(self, df):
        ...
        * stratify splitting avoiding lone classes
        ...
        X_train, X_test, y_train, y_test = train_test_split(
            X, y, random_state=42, stratify=stratify_option
        )
    ...
    def standardize_columns(self, X_train, X_test):
        ...
        * Standardize values for Machine learning
        ...
        for col in self.scored_columns:
            ...
            X_train[f"Standardized {col}"] = (
                (X_train[col] - train_mean) / train_std
            ).round(3)
            X_test[f"Standardized {col}"] = (
                (X_test[col] - train_mean) / train_std
            ).round(3)
